...
RHO_yCo         =	0.94410615; 
RHO_varrho      =	0.73967766; 
RHO_kappa       =	0.736565274; 
RHO_varomega	=	0.845410671; 
RHO_z           =	0.497756816; 
RHO_a           =	0.316593822; 
RHO_zetao       =	0.849218072; 
RHO_zetau       =	0.743732377; 
SIG_yCo         =	0.06847054; 
SIG_varrho      =	0.06121832; 
SIG_kappa       =	0.127529273; 
SIG_varomega	=	0.074980488; 
SIG_z           =	0.0186898; 
SIG_a           =	0.018796754; 
SIG_zetao       =	0.00073068; 
SIG_zetau       =	0.008726603; 
SIG_eR          =	0.001612481; 
...
//estimation(datafile=estim_data, xls_sheet=estim_data, mode_compute=0, mode_file=Standar_mode, mh_replic=500000, mh_jscale=0.36, mh_nblocks=1, plot_priors=0);
