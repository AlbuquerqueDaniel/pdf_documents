% Standar NKSOE model with sticky wages a la Schmitt-Grohé and Uribe (2006)
...
UPSILON	=	0.0496032032024674	;
PHI	=	2.0803221945913700	;
VARSIGMA=	0.8398673729167340	;
PSI	=	0.0047797682142229	;
ETA	=	1.7573319775018800	;
ETASTAR	=	0.1794135409015740	;
GAMA    =       0.805587274404104; //5.479084145; 
THETA_W	=	0.7921613301588550	;
VARTHETA_W=	0.5132703263855290	;
THETA_H	=	0.5464217170559240	;
VARTHETA_H=	0.2050102289175770	;
THETA_F	=	0.5849393265135650	;
VARTHETA_F=	0.5216928426215730	;
RHO_R	=	0.8341160189022900	;
ALPHA_PI=	1.4489727809678900	;
ALPHA_Y	=	0.1375765326264020	;

RHO_yCo	=	0.75; 0.9455331059168890	;
RHO_varrho=	0.75; 0.7102220673925100	;
RHO_kappa=	0.75; 0.7861551152165140	;
RHO_varomega=	0.75; 0.9133015474921530	;
RHO_z	=	0.75; 0.4640556395394940	;
RHO_a	=	0.75/2; 0.2913363122368900	;
RHO_zetao=	0.75; 0.8506861952097500	;
RHO_zetau=	0.75; 0.7490377127034400	;

SIG_yCo	=	0.01; 0.0669772954079511	;
SIG_varrho=	0.01; 0.0689080288884374	;
SIG_kappa=	0.01; 0.0635627760542590	;
SIG_varomega=	0.01; 0.0283603435655631	;
SIG_z	=	0.01; 0.0182128073905957	;
SIG_a	=	0.01; 0.0178033490165969	;
SIG_zetao=	0.01/4; 0.0007329195382733	;
SIG_zetau=	0.01/4; 0.0086553013103102	;
SIG_eR	=	0.01/4; 0.0016634326466487	;
...
//estimation(datafile=estim_data, xls_sheet=estim_data, mode_compute=0, mode_file=Standar_mode, mh_replic=500000, mh_jscale=0.31, mh_nblocks=1, plot_priors=0);
