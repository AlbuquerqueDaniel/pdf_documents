...
RHO_kappa	=	0.771547576; 
RHO_varrho	=	0.639468789; 
RHO_varomega=	0.647259486; 
RHO_rhox	=	0.877520566;
RHO_z       =	0.717311389; 
RHO_a       =	0.347204443; 
RHO_yCo 	=	0.948801805; 
RHO_zetao	=	0.873638845; 
RHO_zetau	=	0.773949583; 
SIG_kappa	=	0.030253667; 
SIG_varrho	=	0.0413235; 
SIG_varomega=	0.025738754; 
SIG_rhox	=	0.152269856;
SIG_z       =	0.007196123; 
SIG_a       =	0.003037889; 
SIG_yCo	    =	0.066067589; 
SIG_zetao	=	0.000760844;
SIG_zetau	=	0.007275765;
SIG_eR      =	0.001662937;
...
//estimation(datafile=estim_data, xls_sheet=estim_data, mode_compute=0, mode_file=Search_mode, mh_replic=500000, mh_jscale=0.35, mh_nblocks=1, plot_priors=0);
